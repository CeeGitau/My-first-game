...
YELLOW_HIT = pygame.USEREVENT + 1 #userevent is sent out as an event signal, repeated periodically after a specified time interval
...
def red_handle_movement(keys_pressed, red):
    ...
    if keys_pressed[pygame.K_UP] and red.y - VEL > 0: #up
         red.y -= VEL
    if keys_pressed[pygame.K_DOWN] and red.y + VEL < HEIGHT - 40: #down
        red.y += VEL
